...
Битрикс CModule*/
Class miet_trade extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "miet.trade";
    var $MODULE_ID = "miet.trade";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("miet.trade_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("miet.trade_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("miet.trade_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("miet.trade_PARTNER_URI");
    }

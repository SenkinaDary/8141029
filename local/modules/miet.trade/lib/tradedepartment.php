...
class TradeDepartmentTable extends Entity\DataManager
{
    ...
    {
        return 't_department_trade';
    }

    /*Описание полей сущности (соответсвуют полям HL DepartmentTrade)*/
    public static function getMap()
    {
        return array(
            ...
            'UF_DEPARTMENT' => array(
                ...
                'required' => true,
                'title' =>
                    Loc::getMessage('Trade_ENTITY_UF_DEPARTMENT_FIELD')
            ),
            'UF_CREATED_BY' => array(
                'data_type' => 'integer',
                'required' => true,
